...
/>
      ...
      <View style={styles.referenceSection}>
        <View style={styles.sectionHeader}>
          <MaterialIcons name="insert-chart-outlined" size={24} color="#37474F" />
      ...
      <View style={styles.reportSection}>
        <View style={styles.sectionHeader}>
          <Ionicons name="document-text-outline" size={24} color="#37474F" />
      ...
      <View style={styles.recommendations}>
        ...
        {recommendations.map((rec, index) => (
          <View
            key={index}
            style={[styles.tipCard, volatilePPM > 2000 && styles.alertTipCard]}
          >
<MaterialCommunityIcons 
  name="lightbulb-on" 
  size={24} 
